...
router.get('/organizations/:id/stats', async (req, res) => {
    try {
        const [
            ...
            Invoice.aggregate([
                // IMPORTANT: aggregate() does NOT auto-cast strings to ObjectId
                // unlike find()/countDocuments(). Must cast explicitly.
                { $match: { organizationId: new mongoose.Types.ObjectId(req.params.id) } },
